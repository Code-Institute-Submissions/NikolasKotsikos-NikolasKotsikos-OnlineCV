...
This is an online cv and portfolio web page for my new career as a junior full stack developer. The project was designed and coded by Nikolas Kotsikos. <br> 
...
-   #### User stories
    ...
    -   ##### First Time Visitor Goals
        ...
        2. As a First Time Visitor, I want to be able to easily navigate throughout the site to find information regarding Nikolas.
        
    -   ##### Returning Visitor Goals

        1. As a Returning Visitor, I want to contact Nikolas with any questions I may have.
        2. As a Returning Visitor, I want to be able to easily get a printable copy of Nikolas's information.
        

    -   ##### Frequent User Goals

        1. As a Frequent User, I want to check to see if there are any newly added projects.
        2. As a Frequent User, I want to check to see if there are any newly added education milestones.
        3. As a Frequent User, I want to easily connect with Nikolas on social media.
...
7. [Balsamiq:](https://balsamiq.com/)
    - Balsamiq was used to create the [wireframes](https://github.com/NikolasKotsikos/NikolasKotsikos-OnlineCV/tree/master/assets/wireframes) during the design process.
...
-   ##### First Time Visitor Goals
    ...
    2. As a First Time Visitor, I want to be able to easily be able to navigate throughout the site to find information regarding Nikolas.
...
-   On some tablet sized devices a thin white line can be seen between the navigation menu and the header background due to an issue with the automatic resizing of the sidebar element. 
...
-  Colapsible button and return to top call to action button will be added in mobile version.
...
-   The reflexive text code for [CSS3](https://en.wikipedia.org/wiki/Cascading_Style_Sheets) was found [here](https://css-tricks.com/books/fundamental-css-tactics/scale-typography-screen-size/).

#### Content

-   All content was written by the developer.

-   The layout design for the project is influenced by the Code Institute Resume Project layout, taught as a learning example during the UX design module. As declared above, no code has been directly copied from said project.

#### Media

-   The image featured on the site was created and edited by the developer.

#### Acknowledgements

-   My mentor [Ashish Srivastava](https://www.linkedin.com/in/techieashish/) for his continuous helpful feedback and morale support!
...
-   My fellow students on Slack for their support and feedback. 
